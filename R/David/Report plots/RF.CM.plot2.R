...
actual <- as.factor(RF.all.test_y$test_y)
...
actual <- as.factor(RF.lymph.test_y$test_y)
cm <- confusionMatrix(pred, actual)
ConfusionTableR::binary_class_cm(pred, actual)
...
actual <- as.factor(RF.myeloid.test_y$test_y)
cm <- confusionMatrix(pred, actual)
ConfusionTableR::binary_class_cm(pred, actual)
...
actual <- as.factor(RF.other.test_y$test_y)
cm <- confusionMatrix(pred, actual)
ConfusionTableR::binary_class_cm(pred, actual)
