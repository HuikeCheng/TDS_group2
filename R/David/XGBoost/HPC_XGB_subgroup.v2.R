...
cm_plot <- ConfusionTableR::binary_visualiseR(train_labels = as.factor(xgb.pred),
                                  truth_labels= as.factor(test_y),
                                  class_label1 = "Control", 
                                  class_label2 = "Lymphoid",
                                  quadrant_col1 = "#28ACB4", 
                                  quadrant_col2 = "#4397D2", 
                                  custom_title = "Lymphoid Cancer Confusion Matrix", 
                                  text_col= "black")
cm_plot
...
a <- grid.grab()
grid.draw(a)
ggsave(filename="../output/XGboost_CF_plot1.pdf", plot=a)
...
#a <- grid.grab()
#grid.draw(a)
#ggsave(filename="../output/XGboost_roc.plot.pdf", plot=a)
